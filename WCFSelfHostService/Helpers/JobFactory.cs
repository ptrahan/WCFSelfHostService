...
using Zetalex.WCFSelfHostService.Helpers;
using Zetalex.WCFSelfHostService.Models;

namespace Zetalex.WCFSelfHostService.Helpers
{
    public static class JobFactory
    {
        public static List<JobModel> GetAllJobs()
        {
            ...
            foreach (JobEnum item in Enum.GetValues(typeof(JobEnum)))
            {
                ...
                jobModel.JobType = Type.GetType("Zetalex.WCFSelfHostService.Jobs." + item.ToString());
